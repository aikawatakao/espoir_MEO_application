...
async function getDashboardStats(storeId: string, period: string) {
    ...
    // Mock other stats for now as we don't have GBP integration
    const stats = {
        reviewCount: totalReviews,
        averageRating: parseFloat(averageRating),
        unrepliedCount,
        impressions: 12500, // Mock
        phoneClicks: 45,    // Mock
        lowRatingRate: 5.2, // Mock or calculate
        directions: 120,    // Mock
        websiteClicks: 85,  // Mock
        ctr: 3.4,           // Mock

        // Graphs data (Mocked structure)
        reviewTrend: [
            { date: "11/01", count: 2 },
            { date: "11/02", count: 1 },
            { date: "11/03", count: 3 },
